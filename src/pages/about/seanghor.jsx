      ...
      <div className="container justify-content-center">
        ...
        <div className="row">
          <div className="col-md-5 p-5">
            <h5>About me</h5>
            <p>
              I am a student of Kirirom Institute of Technology. I am allround
              web developer. I am a senior programmer with good knowledg of
              front-end techniques. I love working with tech enviroment and
              willing to learn and experience new things
            </p>
          </div>
          <div className="col-md-3 pt-5">
            <img
              src="https://m.media-amazon.com/images/I/61z+FW6uxBL.jpg"
              alt=""
              className="img"
            />
          </div>
