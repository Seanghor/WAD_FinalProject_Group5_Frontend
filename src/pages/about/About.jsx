  ...
  return (
    ...
    <div className="team row ">
      <div className="col-md-4 col-12 text-center">
        <img src="../.././assets/image/sotheaban.png" className="img-fluid rounded-circle w-50 p-4" alt=""/>
          <div className="card mr-2 d-inline-block shadow-lg">
            ...
            <div className="card-body">
              ...
              <a href="/" className="text-secondary text-decoration-none">Frontend Developer</a>
                ...
                <div className="carousel-item active">
                  <div className="card mr-2 d-inline-block shadow">
                    ...
                    <div className="card-body">
                      ...
                      <p  className="text-secondary text-decoration-none">Backend Developer</p>
                      <p className="text">Software Engineering </p>
                    </div>
                  </div>
                </div> 
